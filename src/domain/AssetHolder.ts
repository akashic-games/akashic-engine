...
export interface AsssetLoadHandler {
	...
	/**
	 * アセットホルダー読み込み完了イベント。
	 * g.Game#_callAssetHolderHandler() に渡すために自身のインスタンスを発火させている。
 ...
 * 通常、ゲーム開発者が利用する必要はない。
 */
export interface AssetHolderParameterObject {
	/**
...
export class AssetHolder {
	...
	constructor(param: AssetHolderParameterObject) {
